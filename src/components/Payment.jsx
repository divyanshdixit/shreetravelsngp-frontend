...
const Payment = () => {
  ...
  const [clientCode, setClientCode] = useState(
    process.env.REACT_APP_PAISA_CLIENT_CODE
  );
  const [transUserName, setTransUserName] = useState(
    process.env.REACT_APP_PAISA_USER_NAME
  );
  const [transUserPassword, setTransUserPassword] = useState(
    process.env.REACT_APP_PAISA_PASSWORD
  );
  ...
  // const [allTraxnDetails, setAllTraxnDetails] = useState(null);
  ...
  // useEffect(() => {
  //   console.log(allTraxnDetails, location.search);
  //   const data = {};
            ...
            <div className="col-md-12 d-flex justify-content-center">
              ...
              <div className="row mt-3">
                ...
                <div className="col-input">
                  ...
                  <input
                    type="hidden"
                    placeholder="Trnx User Password :"
                    value={transUserPassword}
                    onChange={(e) => setTransUserPassword(e.target.value)}
                  />
                </div>
                <div className="col-input">
