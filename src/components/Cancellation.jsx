...
const Cancellation = () => {
  return (
    <div>
      ...
      <h1> Refund Policy</h1>
      <p style={{textAlign:'left'}}> If you are eligible for refunds based on the <b>"Cancellation and Returns"</b> policy above, then the refund will be remitted back to you in 5-7 working days. In case of any issues, write to us at <b>shreetravelsngp@yahoo.com</b> or call us at <b> +91 982-223-68-02. </b></p>
      </div>
    </div>
  )
}
